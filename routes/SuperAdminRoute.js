...
import { getAllUsers, addNewUser, updateUserProfile, deleteUserById, getDeviceAnalytics } from '../controllers/SuperAdminController.js';
...
router.get('/device-analytics', protect, roles('superadmin'), getDeviceAnalytics);
